       ...
       <div className="wrapperCard">
           <div className="cards">
               {doubleSports.map((value, index) => {
                   return (<Link to="sport-menu" onClick={function(){currSport = [value, maxTeamPlayers[index], minTeamPlayers[index], "team"];
       ...
       <div className="wrapperCard">
           <div className="cards">
               {ESports.map((value, index) => {
                   return (<Link to="sport-menu" onClick={function(){currSport = [value, 4, 4, "team"]}}>
                   <figure className="card">
