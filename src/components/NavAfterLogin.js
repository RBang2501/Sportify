...
export const NavAfterLogin = () => {
  ...
  return (
    <header className="header-area header-sticky" style={{top:"0", position:"fixed", backgroundColor:"white"}}>
                ...
                <div className="col-12">
                    <nav className="main-nav">
                        ...
                        <ul className="nav">
                            ...
                            <li className="scroll-to-section"><a href="#TeamSports">Team Sports</a></li>
